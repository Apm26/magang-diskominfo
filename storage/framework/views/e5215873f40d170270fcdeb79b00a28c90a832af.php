    ...
    <div class="row">
      <div class="col-lg-3 col-md-6 col mb-2">
        <div class="bg-white rounded-3 shadow p-2 d-flex align-items-center justify-content-around">
          ...
          <img src="<?php echo e(asset('assets/icons/ic-book.png')); ?>" height="40" width="40" alt="pendidikan">
        </div>
      </div>
      <div class="col-lg-3 col-md-6 col mb-2">
        <div class="bg-white rounded-3 shadow p-2 d-flex align-items-center justify-content-around">
          ...
          <img src="<?php echo e(asset('assets/icons/ic-globe.png')); ?>" height="40" width="40" alt="pendidikan">
        </div>
      </div>
      <div class="col-lg-3 col-md-6 col mb-2">
        <div class="bg-white rounded-3 shadow p-2 d-flex align-items-center justify-content-around">
          ...
          <img src="<?php echo e(asset('assets/icons/ic-neraca.png')); ?>" height="40" width="40" alt="pendidikan">
        </div>
      </div>
      <div class="col-lg-3 col-md-6 col mb-2">
        <div class="bg-white rounded-3 shadow p-2 d-flex align-items-center justify-content-around">
          ...
          <img src="<?php echo e(asset('assets/icons/ic-komputer.png')); ?>" height="40" width="40" alt="pendidikan">
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row py-5">
      <div class="col-lg-4">
        <div class="card border-0">
          <img src="<?php echo e(asset('assets/images/berita-1.jpg')); ?>" class="img-fluid mb-3" alt="berita 1">
      ...
      <div class="col-lg-4">
        <div class="card border-0">
          <img src="<?php echo e(asset('assets/images/berita-2.jpg')); ?>" class="img-fluid mb-3" alt="berita 2">
          <div class="konten-berita">
            <p class="mb-3 text-secondary">21 April 2023</p>
      ...
      <div class="col-lg-4">
        <div class="card border-0">
          <img src="<?php echo e(asset('assets/images/berita-3.jpg')); ?>" class="img-fluid mb-3" alt="berita 3">
          <div class="konten-berita">
            <p class="mb-3 text-secondary">21 April 2023</p>
...
<section id="join" class="py-5">
  <div class="container py-5">
    <div class="row">
      ...
      <div class="col-lg-6">
        <img src="<?php echo e(asset('assets/images/profil-1.jpg')); ?>" width="88%" height="88%" alt="foto mesjid">
      </div>
    </div>
  </div>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-3 col-md-6 col-6">
        <img src="<?php echo e(asset('assets/images/kegiatan-1.jpg')); ?>" class="img-fluid" height="50px" alt="foto 1">
      </div>
      <div class="col-lg-3 col-md-6 col-6">
        <img src="<?php echo e(asset('assets/images/kegiatan-2.jpeg')); ?>" class="img-fluid" height="50px" alt="foto 2">
      </div>
      <div class="col-lg-3 col-md-6 col-6">
        <img src="<?php echo e(asset('assets/images/kegiatan-3.jpg')); ?>" class="img-fluid" height="50px" alt="foto 3">
      </div>
      <div class="col-lg-3 col-md-6 col-6">
        <img src="<?php echo e(asset('assets/images/kegiatan-4.jpg')); ?>" class="img-fluid" height="50px" alt="foto 4">
      </div>
    </div>
  </div>
</section>
...
<?php /**PATH C:\Users\Nur Kamil\OneDrive\Documents\File koding agung\magang-laravel\diskominfokabbdg_redesign\resources\views/home.blade.php ENDPATH**/ ?>